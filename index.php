...
<html lang="en">
  <head>
    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
      ...
      <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBxz2nBOJH8COeF2GKyPYb4NC1h3kB6a6w"></script>
      <!-- <script async
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAG88u8eSCfXOUPsGzhG1wzrD9bdFYjdRo&libraries=places">
</script> -->
      <style>
  ...
  <body>
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
              <p>Mini Project Copyright &copy; 2023-<?php $today = date("Y"); echo $today?>.</p>
          </div>
      </div>
