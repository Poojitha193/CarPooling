...
<html lang="en">
  <head>
    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
      ...
      <!-- <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBeMi5XqVH299IGHL3bybAS5O6AFgPIcS0&callback=initialize"></script> -->
      <script async
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBxz2nBOJH8COeF2GKyPYb4NC1h3kB6a6w&libraries=places">
</script>
      <style>
      <style>
      #map {
...
<!--Container-->
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
              <p>CarPooling Copyright &copy; 2023-<?php $today = date("Y"); echo $today?>.</p>
          </div>
      </div>
